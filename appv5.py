...
if data:
    ...
    if st.button("AI精密査定を実行"):
        ...
        # ログ表示用のTier_Factorを取得
        try:
            display_factor = tier_master.loc[selected_loc, 'Tier_Factor']
        except:
            display_factor = 1.000
